...
def log_resource_usage(step_name):
    ...
    log_to_json(step_name, cpu_usage=cpu_usage, memory_usage=memory_info.percent)

def log_api_latency(start_time, end_time, step_name):
    latency = end_time - start_time
    log_to_json(step_name, latency_seconds=round(latency, 2))

def log_query_time(start_time, end_time, step_name):
    elapsed_time = end_time - start_time
    log_to_json(step_name, execution_time_seconds=round(elapsed_time, 2))
